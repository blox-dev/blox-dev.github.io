...
- **CarcassonneAR**
	- **Language: C#/Unity**
	- [[Repository]](https://github.com/blox-dev/CarcassonneAR) During this project we have built the Carcassonne board game with AR technologies using the Vuforia SDK and Unity.